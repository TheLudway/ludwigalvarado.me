...
\resumeSubheading
    {Ingeniero de Pruebas}{Bogotá, Colombia}
    {ROSEN Group}{Ene. 2026 -- Jul. 2026}
    \resumeItemListStart
      \item Seguimiento ciclo de vida del software.
      \item Automatizar pruebas.
    \resumeItemListEnd
...
\textbf{DevOps y Herramientas:} Git, GitHub Actions, Docker, Administración de Sistemas Linux, CI/CD, Azure DevOps \\
...
\resumeSubHeadingListStart
\item Ganador Hackatón RiskTech (1.º lugar, 2025).
\item Segundo Lugar Hackatón Desafío Inteligente, Ministerio de Minas y Energía (2025).
